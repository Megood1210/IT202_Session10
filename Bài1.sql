...
values ('nguyen_test', 'Nguyễn Văn Test', 'Nam', 'nguyentest@gmail.com', '123', '1996-01-01', 'Hà Nội');
-- Truy vấn lại view view_users_firstname 
select * from view_users_firstname;
--  xóa nhân viên vừa thêm khỏi bảng Users
delete from users
